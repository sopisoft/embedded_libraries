...
use imu::{
    ...
    MagnetometerCalibrator, MargSample, SharedI2c, StationaryDetection, Vector3,
    display_attitude, display_orientation, find_i2c_address_by_id,
...
pub const ESKF_ALTITUDE_FEEDBACK_NOISE_M: f32 = 0.05;
...
pub fn log_filter_configuration() {
    ...
    defmt::info!(
        "filter eskf altitude_feedback_noise_m={:?} vertical_speed_feedback_noise_m_s={:?}",
        ESKF_ALTITUDE_FEEDBACK_NOISE_M,
