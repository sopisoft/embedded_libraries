...
impl AccelGyroSample {
    ...
    pub const fn new(accel_m_s2: Vec3, gyro_rad_s: Vec3, temperature_c: Option<f32>) -> Self {
        Self {
            accel_m_s2,
            gyro_rad_s,
            temperature_c,
    ...
    pub const fn without_temperature(accel_m_s2: Vec3, gyro_rad_s: Vec3) -> Self {
...
impl MargSample {
    ...
    pub const fn new(accel_gyro: AccelGyroSample, mag_body: Vec3) -> Self {
        Self {
            accel_gyro,
            mag_body,
        }
